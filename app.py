...
# ------------------------------
# 3. Set background image (Fixed Indentation)
# ------------------------------
...
try:
    # Using the filename from your error/script: fire_risk_model.pkl
    model = joblib.load('fire_risk_model.pkl')
    MODEL_LOADED = True
except FileNotFoundError:
    st.error("Error: fire_risk_model.pkl file not found. Please ensure the model is in the project directory.")
    MODEL_LOADED = False
